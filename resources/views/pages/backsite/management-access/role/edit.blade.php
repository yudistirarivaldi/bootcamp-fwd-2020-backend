                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.role.update', [$role->id]) }}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div
                                                    class="form-group row {{ $errors->has('permissions') ? 'has-error' : '' }}">
                                                    <label class="col-md-3 label-control">Permission <code
                                            ...
                                            <div class="form-actions text-right">
                                                <a href="{{ route('backsite.role.index') }}" style="width:120px;"
