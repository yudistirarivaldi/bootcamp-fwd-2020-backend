                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.config_payment.update', [$config_payment->id]) }}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="fa fa-edit"></i> Form Config
                                                    Payment</h4>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="fee" name="fee" class="form-control"
                                                            placeholder="example fee 10000"
                                                            value="{{ old('fee', isset($config_payment) ? $config_payment->fee : '') }}"
                                                            autocomplete="off"
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="vat">Vat <code
                                                            style="color:red;">required</code></label>
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="vat" name="vat" class="form-control"
                                                            placeholder="example vat 10000"
                                                            value="{{ old('vat', isset($config_payment) ? $config_payment->vat : '') }}"
                                                            autocomplete="off"
                                                            data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'autoGroup': true, 'digits': 0, 'digitsOptional': 0, 'prefix': '', 'placeholder': '0'"
                                                            required>
                                            ...
                                            <div class="form-actions text-right">
                                                <a href="{{ route('backsite.config_payment.index') }}"
