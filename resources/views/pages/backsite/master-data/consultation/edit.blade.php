                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.consultation.update', [$consultation->id]) }}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="fa fa-edit"></i> Form Specialist
                                                </h4>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="name" name="name" class="form-control"
                                                            ...
                                                            value="{{ old('name', isset($consultation) ? $consultation->name : '') }}"
                                            ...
                                            <div class="form-actions text-right">
                                                <a href="{{ route('backsite.consultation.index') }}" style="width:120px;"
