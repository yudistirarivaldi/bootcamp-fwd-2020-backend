...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="#"><i
                        class="{{ request()->is('backsite/doctor') ||request()->is('backsite/doctor/*') ||request()->is('backsite/*/doctor') ||request()->is('backsite/*/doctor/*') ||request()->is('backsite/hospital_patient') ||request()->is('backsite/hospital-patient/*') ||request()->is('backsite/*/hospital-patient') ||request()->is('backsite/*/hospital-patient/*') ||request()->is('backsite/appointment') ||request()->is('backsite/appointment/*') ||request()->is('backsite/*/appointment') ||request()->is('backsite/*/appointment/*') ||request()->is('backsite/transaction') ||request()->is('backsite/transaction/*') ||request()->is('backsite/*/transaction') ||request()->is('backsite/*/transaction/*')? 'bx bx-hive bx-flashing': 'bx bx-hive' }}"></i><span
                ...
                <ul class="menu-content">
                    ...
                    <li
                        class="{{ request()->is('backsite/hospital-patient') ||request()->is('backsite/hospital-patient/*') ||request()->is('backsite/*/hospital-patient') ||request()->is('backsite/*/hospital-patient/*')? 'active': '' }} ">
                        <a class="menu-item" href="{{ route('backsite.hospital-patient.index') }}">
